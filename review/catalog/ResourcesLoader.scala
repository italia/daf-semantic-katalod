...
import it.almawave.kb.catalog.meta.OntologyMeta
import it.almawave.kb.catalog.meta.VocabularyMeta
  ...
  def fetchOntologies(useCache: Boolean = true): Seq[OntologyMeta] = {
    ...
    onto_conf
      ...
      .map { item =>
        ...
        OntologyMetadataExtractor(data_url)
  ...
  def fetchVocabularies(useCache: Boolean = true): Seq[VocabularyMeta] = {
    ...
    onto_conf
      ...
      .map { item =>
        ...
        VocabularyMetadataExtractor(data_url)
